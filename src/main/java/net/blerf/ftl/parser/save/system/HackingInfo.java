...
import net.blerf.ftl.parser.save.*;
import net.blerf.ftl.parser.save.drone.DronePodState;
...
public class HackingInfo extends ExtendedSystemInfo {
    private SavedGameParser.SystemType targetSystemType = null;
     ...
     */
    public void setTargetSystemType( SavedGameParser.SystemType systemType ) { targetSystemType = systemType; }
    public SavedGameParser.SystemType getTargetSystemType() { return targetSystemType; }
    ...
    public String toString() {
        ...
        result.append( String.format( "SystemId:                 %s\n", SavedGameParser.SystemType.HACKING.getId() ) );
