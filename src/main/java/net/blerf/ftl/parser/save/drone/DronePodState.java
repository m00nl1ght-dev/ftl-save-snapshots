...
import net.blerf.ftl.parser.save.system.WeaponModuleState;

import java.util.List;

public class DronePodState {
    private SavedGameParser.DroneType droneType = null;
    ...
    public void setDroneType( SavedGameParser.DroneType droneType ) { this.droneType = droneType; }
    public SavedGameParser.DroneType getDroneType() { return droneType; }
