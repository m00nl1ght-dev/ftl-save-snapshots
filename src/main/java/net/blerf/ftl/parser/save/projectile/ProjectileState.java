...
import net.blerf.ftl.parser.save.DamageState;
import net.blerf.ftl.parser.save.SavedGameParser;

public class ProjectileState {
    private SavedGameParser.ProjectileType projectileType = SavedGameParser.ProjectileType.INVALID;
    ...
    public void setProjectileType( SavedGameParser.ProjectileType t ) { projectileType = t; }
    public SavedGameParser.ProjectileType getProjectileType() { return projectileType; }
    ...
    public String toString() {
        ...
        if ( SavedGameParser.ProjectileType.INVALID.equals( projectileType ) ) {
            result.append( "\n" );
