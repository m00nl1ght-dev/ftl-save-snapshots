...
public class FTLUtilities {
	...
	public static File findDatsDir() {
		...
		String gogGalaxyPath = "GOG Galaxy/Games/FTL Advanced Edition";
		...
		if ( programFiles86 != null ) {
			...
			candidates.add( new File( new File( programFiles86 ), gogGalaxyPath ) );
		...
		if ( programFiles != null ) {
			...
			candidates.add( new File( new File( programFiles ), gogGalaxyPath ) );
